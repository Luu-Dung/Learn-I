...
/*
    ...
    |       .....                    |           |       .....               |         
    |   Send a signal to process 2   |      ->   |   Perform signal handler  |at a time, reciving exaclty signal (it is set in signal handler) 
    |       .....                    |           |       ......              |
    ----------------------------------           -----------------------------
...
void parent_code(pid_t cpid) {
  ...
  puts("Parent woke up and sent SIGTERM to child then wait its end...");
